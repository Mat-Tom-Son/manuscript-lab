...
const forbidden = [
  ...
  {
    label: "ignored eval subject project file",
    test: (file) =>
      file.startsWith("evals/") &&
      ["/subject/brief.md", "/subject/outline.md", "/subject/style.md"].some((suffix) => file.endsWith(suffix)),
  },
...
const required = [
  ...
  "scripts/lib/model-fingerprints.mjs",
  "scripts/lib/narrative-schema.mjs",
  "scripts/lib/required-scaffolding.mjs",
  "scripts/lib/review-registry.mjs",
  "scripts/lib/style-registry.mjs",
  "scripts/review-registry.test.mjs",
  "scripts/narrative-signals.mjs",
  "scripts/narrative-signals.test.mjs",
  "docs/MCP.md",
  "docs/COMMANDS.md",
  "docs/NARRATIVE.md",
  "narrative/features.json",
  "narrative/prompts/template-extract.md",
  ".pi/prompts/doc-chorus-plan.md",
  ".pi/prompts/doc-chorus-run.md",
  ".pi/prompts/doc-chorus-report.md",
  ".pi/prompts/doc-room-blue-sky.md",
  ".pi/prompts/doc-room-diagnose.md",
  ...
  "docs/GOLDEN_PATH.md",
  "docs/PRIMITIVE_CONTRACTS.md",
  "reviews/prompts/room-table-read.md",
  "reviews/prompts/narrative-default-pressure.md",
  "reviews/prompts/scene-turn.md",
  "scripts/artifact-inspector.mjs",
  "scripts/chorus-runner.mjs",
  "scripts/chorus-runner.test.mjs",
  "scripts/eval-runner.mjs",
  "scripts/golden-path.mjs",
  "scripts/lib/generated-artifacts.mjs",
