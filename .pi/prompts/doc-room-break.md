...
4. Use the beat board to update `outline.md`, the section contract, continuity,
   claims, or open questions only when the human accepts that direction.
5. Do not draft manuscript prose unless the user also asked for drafting or revision.
